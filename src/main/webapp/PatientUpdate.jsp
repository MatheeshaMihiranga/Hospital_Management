...
<body>
	<img src="css/Images/hospitalbackground.png" class="backgroundimg" />
	<div class="hero">
		...
		<div class="page_content">
			...
			<%
			ResultSet rs = myConn.execute("SELECT * FROM `patient` WHERE `email` = '" + PatientDetails.getEmail() + "' ");

			if (rs.next()) {
			%>

			<div class="acc_info">
				<form action="PUPP" method="POST">
							...
							<div class="input_box">
								...
								<div style="flex: 0.8; display: flex">
									<input type="text" style="width: 50%" readonly="readonly"
										name="" value="<%=rs.getString(1)%>" required />
								</div>
							</div>
							<div class="input_box">
								<div style="flex: 0.2; display: flex">
				...
				<form action="PDP" method="post">
					<button type="submit" class="save_button" name="changePassword">Delete Account</button>
				</form>
